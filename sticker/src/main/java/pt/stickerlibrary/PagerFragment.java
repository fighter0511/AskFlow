...
public class PagerFragment extends Fragment implements PagerItemFragment.OnChildInteractionListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        List<ArrayList<Integer>> listSticks = new ArrayList<ArrayList<Integer>>();
        SetSticker setSticker = new SetSticker();
        ArrayList<Integer> listEmoticon = setSticker.listEmoticon();
        ArrayList<Integer> listEch = setSticker.listEch();
        ArrayList<Integer> listMeep = setSticker.listMeep();
        ArrayList<Integer> listRab = setSticker.listRab();
        listSticks.add(listEmoticon);
        listSticks.add(listRab);
        listSticks.add(listEch);
        listSticks.add(listMeep);
        ChatStixAdapter pageAdapter = new ChatStixAdapter(getChildFragmentManager(), listSticks);
