...
public class PagerItemFragment extends Fragment {
    ...
    public static PagerItemFragment newInstance(ArrayList<Integer> listSticker) {
        PagerItemFragment fragment = new PagerItemFragment();
        Bundle args = new Bundle();

        args.putIntegerArrayList("sticker", listSticker);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listSticker = getArguments().getIntegerArrayList("sticker");
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        sitckerGridAdapter = new EmoAdapter(getActivity(), listSticker);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                mChildListener.clickOnItem(listSticker.get(i));
            }
        });
