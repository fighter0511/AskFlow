...
//        textView.setBackgroundColor(R.color.bg_horizontal_item);
    ...
    private void populateTabStrip() {
        ...
        ArrayList<Integer> listTabIcon = new ArrayList<Integer>();
        listTabIcon.add(R.drawable.emoticon_1);
        listTabIcon.add(R.drawable.rab1);
        listTabIcon.add(R.drawable.ech1);
        listTabIcon.add(R.drawable.meep1);
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != 0) {
                ...
                tabTitleView.setImageResource(listTabIcon.get(i));
            }
