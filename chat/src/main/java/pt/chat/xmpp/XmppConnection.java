...
import pt.chat.crypto.XmppDomainVerifier;
import pt.chat.crypto.sasl.DigestMd5;
import pt.chat.crypto.sasl.External;
import pt.chat.crypto.sasl.Plain;
import pt.chat.crypto.sasl.SaslMechanism;
import pt.chat.crypto.sasl.ScramSha1;
import pt.chat.entities.Account;
import pt.chat.entities.Message;
import pt.chat.generator.IqGenerator;
import pt.chat.services.XmppConnectionService;
import pt.chat.utils.DNSHelper;
import pt.chat.utils.SSLSocketHelper;
import pt.chat.utils.SocksSocketFactory;
import pt.chat.utils.Xmlns;
import pt.chat.xml.Element;
import pt.chat.xml.Tag;
import pt.chat.xml.TagWriter;
import pt.chat.xml.XmlReader;
...
import pt.chat.xmpp.stanzas.AbstractAcknowledgeableStanza;
...
import pt.chat.xmpp.stanzas.csi.ActivePacket;
import pt.chat.xmpp.stanzas.csi.InactivePacket;
import pt.chat.xmpp.stanzas.streammgmt.AckPacket;
import pt.chat.xmpp.stanzas.streammgmt.EnablePacket;
import pt.chat.xmpp.stanzas.streammgmt.RequestPacket;
import pt.chat.xmpp.stanzas.streammgmt.ResumePacket;
